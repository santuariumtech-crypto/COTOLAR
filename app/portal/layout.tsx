        ...
        <div className="px-3 pb-5 border-t border-white/10 pt-4 space-y-3">
          <div className="flex items-center gap-3 px-3">
            ...
            <div className="min-w-0">
              <p className="text-white text-xs font-semibold truncate">Romero Brandon Elias</p>
              <p className="text-blue-300 text-[10px] truncate">Mat. N° 0423</p>
            </div>
          </div>
          <Link
            href="/"
            className="flex items-center gap-3 px-3 py-2 rounded-xl text-sm text-blue-200 hover:bg-white/10 hover:text-white transition-all"
          >
